        ...
        >
            <form className="w-full space-y-4" onSubmit={handleSubmit}>
                ...
                <div className="space-y-2 text-left">
                    <Input
                        type="text"
                        placeholder="Display Name: CodeKage"
                ...
                <Button
                    type="submit"
                    disabled={isLoading}
                    className="w-full h-11 text-base font-semibold rounded-full hover:bg-primary/90 cursor-pointer mt-4"
                >
                    {isLoading ? (
                        <><Loader2 className="size-4 animate-spin mr-2" /> Creating keys...</>
                    ) : 'SIGN UP'}
                </Button>
            </form>
        </motion.div>
